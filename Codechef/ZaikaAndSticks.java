...
//  javac -d ../../classes ZaikaAndSticks.java
//  java ZaikaAndSticks
    ...
    void solve() throws Exception
    {
        //for(int tc = hp.nextInt(); tc > 0; tc--)
        {
            ...
            for(int i = 0; i < n - 2; i++)
            {
                ...
                if(isValid(arr[i], arr[i + 1], arr[i + 2]))
                {
                    flag = true;
                    hp.println("YES");
                    String[] nums = {(arr[i] + ""), (arr[i + 1] + ""), (arr[i + 2] + "")};
                    Arrays.sort(nums, Collections.reverseOrder());
                    //hp.println();
                    hp.println(nums[0] + " " + nums[1]  + " "+ nums[2]);
                    break;
                }
