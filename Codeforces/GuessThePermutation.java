...
//  javac -d ../../classes GuessThePermutation.java
//  java GuessThePermutation
    ...
    void solve() throws Exception
    {
        //for(int tc = hp.nextInt(); tc > 0; tc--)
        {
            ...
            for(int i = 0; i < n; i++)
            {
                ...
                if(hs.size() < n)
                {
                    if(hs.size() == n - 1 && !nminus1)
                        nminus1 = true;
                    else if(hs.size() == n - 1 && nminus1)
                        continue;
                    ans[i] = hs.size();


                    //hp.println("at " + i + " = " + hs.size());
                }
            }
            for(int i = 0; i < n; i++)
