...
//  javac -d ../../classes PoweredAddition.java
//  java PoweredAddition
...
class Solver {
    ...
    void solve() throws Exception
    {
        for(int tc = hp.nextInt(); tc > 0; tc--)
        {
            ...
            int high = 40, low = 0;
            int ans = binarySearchCheck(arr, high, low);
            hp.println(ans - 1);
        }
        hp.flush();
    }

    int binarySearchCheck(long[] arr, int high, int low)throws Exception
    {
        int i = high;
        for(i = high; i > low; i--)
        {
    ...
    boolean check(long[] ar, long k)throws Exception
    {
        boolean flag = true;
        long max = ar[0];
