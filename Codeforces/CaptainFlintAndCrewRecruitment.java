...
//  javac -d ../../classes CaptainFlintAndCrewRecruitment.java
//  java CaptainFlintAndCrewRecruitment
...
class Solver {
    ...
    void process(int n)throws Exception
    {
        if(n >= 31){
            hp.println("YES");
            if(n - 30 == 6)
                hp.println(10 + " " + 6 + " " + 5 + " " + 15);
            else if(n - 30 == 14)
                hp.println(10 + " " + 7 + " " + 6 + " " + 21);
            else if(n - 30 == 10)
                hp.println(10 + " " + 22 + " " + 2 + " " + 6);
            /*
            hp.print(6 + " " + 14 + " " + 10 + " ");
            hp.print(n - 30);
            */
            else
                hp.println(6 + " " + 14 + " " + 10 + " " + (n - 30));
        }
        else
            hp.println("NO");
    }
