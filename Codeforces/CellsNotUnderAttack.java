...
//  javac -d ../../classes CellsNotUnderAttack.java
//  java CellsNotUnderAttack
...
class Solver {
    ...
    void solve() throws Exception
    {
        ...
        for(int tc = hp.nextInt(); tc > 0; tc--)
        {
            ...
            hs.add(x);
            vs.add(y);
            //hp.println(hs.size() + " " + vs.size());
            long total = (((long)(hs.size() * n) + ((long)vs.size() * n)) -
                            ((long)hs.size() * (long)vs.size()));
            hp.print(((n * n ) - total) + " ");
