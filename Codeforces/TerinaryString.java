...
//  javac -d ../../classes TerinaryString.java
//  java TerinaryString
        ...
        for(int tc = hp.nextInt(); tc > 0; tc--)
        {
            ...
            if(one && two && three)
            {
                ...
                for(int i = 0; i < s.length; i++)
                {
                    ...
                    {
                        l1 = i;
                        long dist = (long)i - (Math.min(l2, l3));
                        min = Math.min(dist, min);
                    }
                    if(s[i] == '2')
                    {
                        l2 = i;
                        long dist = (long)i - (Math.min(l1, l3));
                        min = Math.min(dist, min);
                    }
                    if(s[i] == '3')
                    {
                        l3 = i;
                        long dist = (long)i - (Math.min(l1, l2));
                        min = Math.min(dist, min);
                    }
                }
                hp.println(min + 1);
