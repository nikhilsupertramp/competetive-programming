...
////javac -d ../../classes FriendsAndGifts.java
//problem link : https://codeforces.com/contest/1283/problem/C
    ...
    int[] process(int n, int[] arr) throws Exception
    {
        int[] takes = new int[n];
        int[] gives = new int[n];
        for(int i = 0; i < n; i++)
        ...
        hp.println(Arrays.toString(takes));
        hp.println(Arrays.toString(gives));
    }
