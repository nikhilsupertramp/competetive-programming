...
public class BottomUpLevelOrderTree
{
...
//  javac -d ../../classes BottomUpLevelOrderTree.java
//  java BottomUpLevelOrderTree
...
class Solver {
    ...
    void solve() throws Exception
    {
        for(int tc = hp.nextInt(); tc > 0; tc--)
        {
            ...
            bottomUpLevelOrderTraversal(root);
            hp.println();
    ...
    void bottomUpLevelOrderTraversal(TreeNode root)throws Exception
    {
        if(root == null)return;
