...
//  javac -d ../../classes FindingTheCeil.java
//  java FindingTheCeil
// https://www.hackerrank.com/contests/smart-interviews-16a/challenges/si-finding-the-ceil
...
class Solver {
    ...
    int findCeil(int[] arr, int query)
    {
        int index = Arrays.binarySearch(arr, query);
