...
//  javac -d ../../classes ZigZagLevelOrder.java
//  java ZigZagLevelOrder
//  https://www.hackerrank.com/contests/smart-interviews/challenges/si-zig-zag-level-order-of-tree
...
class Solver {
    ...
    void zigZagLevelOrder(TreeNode root)throws Exception
    {
        if(root == null)return;
